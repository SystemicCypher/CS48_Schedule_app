...
public class MainActivity extends AppCompatActivity {
    ...
    int cc;
    int desired = 3
            ;//this is the value of classes student wants to take
    @Override
                ...
                if((!check)&&(selectedClass!="Course")&&classCount > 0&&(selectedClass!=null)) {
                    ...
                    delete.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            String name = ((TextView) parent.getVirtualChildAt(0)).getText().toString();
            ...
            public void onClick(View v) {
                ...
                //first calls addclass function for all the values in classes
                    ...
                    for (int x=0; x<classes.size();x++) {
                        ...
                        for (int i = 0; i<subjectIDRatings.length(); i++){
                            if (Character.isDigit(subjectIDRatings.charAt(i)) ) {
                                num = i;
                                i=100;
                            }
                        }
                        ...
                        try {
                            ...
                            while ((line = reader.readLine()) != null) {
                                ...
                                course = split.get(0);
                                String t = classes.get(x).getString().toLowerCase();
                                t = t.replaceAll(" ", "");
                                if (course.toLowerCase().equals(t  )) {
                                    last = split.get(1);
                                    other = split.get(2);
                                    days = split.get(3);
                                    time = split.get(4);
                   ...
                   // Intent intent = new Intent(MainActivity.this,display_classes.class);
                   // startActivity(intent);
                   // super.onCreate(savedInstanceState);

                    setContentView(R.layout.activity_display_classes);
                    tv = (TextView) findViewById(R.id.textView);
                    tv.setText(menu.printOptimized());
                    ...
                    if (menu.schedules.length != 0) {
                        ...
                        nextButton.setOnClickListener(new View.OnClickListener() {
                            ...
                            @Override
                            public void onClick(View v) {
                                if (check < menu.schedules.length) {
                                    tv.setText(menu.printOptimized());
                                    check++;
                                }
                                else {
                                    tv.setText("No More Available Schedules");
                                }
                            }
